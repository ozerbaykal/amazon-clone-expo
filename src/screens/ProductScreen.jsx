    ...
    <SafeAreaView>
      <ScrollView style={styles.container}>
        ...
        <Text style={styles.tagline}>
          Price and other details waw vary based on product aside and colour
        </Text>
        {ProductData.map((item, index) => (
          <View key={item.id || index} style={styles.productSection}>
            ...
            <View style={styles.productDetailSection}>
              ...
              <Text style={styles.cashback}>
                Up to 5% cach with Amazon Pay Credit card
              </Text>
